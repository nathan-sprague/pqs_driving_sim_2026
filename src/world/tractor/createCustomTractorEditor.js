...
export async function createCustomTractorEditor(container, onChange) {
  ...
  async function addWheelPair(position) {
    ...
    const file = `/assets/models/tractor/${position}_wheel/${position}_wheel.glb`;
